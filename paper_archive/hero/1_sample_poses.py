...
from ram.dataset.kinematics import transformation_matrix
...
# 1. Setup Colors
c0 = np.array(get_plt_colour(0))  # End color
c1 = np.array(get_plt_colour(1))  # Start color (the vibrant one)
